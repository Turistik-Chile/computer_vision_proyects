...
class TelefericoCounterV3:
    ...
    def _subir_solo_a_blob_storage(self):
        ...
        try:
            ...
            # Reemplazar timestamp por las 4 columnas al inicio para facilitar consultas
            columnas = ['anio', 'mes', 'dia', 'hora_minuto', 'cabina_numero', 'personas_embarcadas', 'hora_paso', 'ids_personas', 'ignore']
            df = df[columnas]
